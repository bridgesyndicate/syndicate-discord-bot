...
bot.register_application_command(:example, 'Example commands', server_id: '855996952348327946') do |cmd|
...
bot.register_application_command :spongecase, 'Are you mocking me?', server_id: '855996952348327946' do |cmd|
